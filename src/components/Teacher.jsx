...
import { useAITeacher, teachers } from "@/hooks/useAITeacher";
...
export function Teacher({ teacher, ...props }) {
  ...
  // State for blink animation (imported from r3f-virtual-girlfriend project)
  ...
  useEffect(() => {
    if (loading) {
      ...
      setAnimation(MathUtils.randInt(0, 1) ? "Talking" : "Talking2");
    } else {
      setAnimation("Idle");
    }
